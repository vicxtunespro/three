...
export default function NavBar({disableDropdown}) {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between px-16 py-4 bg-white shadow-md">
        ...
        <div className="relative">
          ...
          {isAccountDropdownOpen && (
            <div
              ...
              className="absolute -left-8  mt-2 w-48 bg-white border border-gray-100 rounded shadow-lg z-30">
              {/* Dropdown items */}
        ...
        <div className="relative">
          ...
          {isHelpDropdownOpen && (
            <div 
              ...
              className="absolute -left-8 mt-2 w-56 bg-white border border-gray-200 rounded-md shadow-lg">
              <ul>
